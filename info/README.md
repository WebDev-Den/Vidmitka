...
- [day-timeline.md](day-timeline.md) — жива шкала пар/перерв (опубліковано) та VID-011: вибір кольору без видимої назви (незалежний QA PASS, не опубліковано).
- [attendance.md](attendance.md) — журнал за датами, імпорт студентів CSV/JSON, підгрупи та правила відвідування.
- [groups-and-lesson-rosters.md](groups-and-lesson-rosters.md) — вибір / створення груп, прив’язка студентів; VID-015: створення без студентів і пізніше доповнення списку, QA очікується.
