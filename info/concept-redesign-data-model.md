...
`one_time` не потребує `base_entry_id` і містить повний набір даних разового заняття. Саме цей тип є безпечним первинним mapping для наданого датованого JSON.
